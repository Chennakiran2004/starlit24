...
//   const location = useLocation();
//   const navigate = useNavigate();
//   const [isScrolledNav, setNavigationScroll] = useState("Home");
...
//             <Link to="/Home" className="hover:bg-purple-700 px-3 py-2 rounded-md transition-colors" style={isScrolledNav === "Home" && location.pathname === "/Home" ?{ backgroundColor: "purple" }:{ backgroundColor: "transparent" } }>
//               Home
//             </Link>
//             {menuItems.map(({ label, id, offset }) => (
//               <div onClick={() => setNavigationScroll(label)}>
//               <button
//                 key={id}
//                 className="hover:bg-purple-700 px-3 py-2 rounded-md transition-colors"
//                 style={isScrolledNav === label ?{ backgroundColor: "rgb(126 34 206)" }:{ backgroundColor: "transparent" } }
...
//     >
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className={`flex items-center justify-${window.innerWidth < 768 ? "between" : "around"} h-16`} style={{ height: "70px" }}>
//           {/* Logo */}
//           {(location.pathname !== "/Home" || isScrolled || window.innerWidth < 768) && (
//             <div className="flex items-center">
//               <Link to="/Home">
...
//               to="/Home"
//               className="hover:bg-purple-700 px-3 py-2 rounded-md transition-colors"
//               style={activeSection === "home" ? { backgroundColor: "rgb(126 34 206)" } : { backgroundColor: "transparent" }}
//             >
//               Home
//             </Link>
//             {menuItems.map(({ label, id, offset }) => (
...
//               to="/Home"
//               className="hover:bg-purple-700 px-3 py-2 rounded-md transition-colors"
//               style={activeSection === "Home" ? { backgroundColor: "purple" } : {}}
//             >
//               Home
//             </Link>
//             {menuItems.map(({ label, id, offset }) => (
...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className={`flex items-center justify-${window.innerWidth < 768 ? "between" : "around"} h-16`}
          style={{ height: "70px" }}
        >
          {/* Logo */}
          {(location.pathname !== "/Home" || isScrolled || window.innerWidth < 768) && (
